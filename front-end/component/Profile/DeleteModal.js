...
import { deleteProfile } from "Components/actions/models/profile";
import { verifyProcess } from "Components/actions/auth";
import { setErrors, clearErrors } from "Components/actions/control/errors";
      ...
      <div>
        <Modal show={this.props.show}>
          ...
          <Modal.Footer>
            ...
            <Button variant="primary" onClick={this.props.toggleDeleteModal}>
              Cancel
            </Button>
          </Modal.Footer>
        </Modal>
